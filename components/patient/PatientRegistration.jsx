...
if (!indianMobileRegex.test(formData.phone)) {
  ...
  return;
    ...
    try {
      ...
      toast.success("Registration successful! Welcome to MediLocker!");
    ...
    <div className="max-w-5xl mx-auto py-8 relative">
      ...
      <div className="text-center mb-12 relative z-10">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
          Join our secure healthcare platform and take control of
          ...
          <div className="space-y-6">
            ...
            <div className="text-gray-700 space-y-4 leading-relaxed">
              <p className="font-medium">
                By registering as a patient on MediLocker, you agree to:
              </p>
